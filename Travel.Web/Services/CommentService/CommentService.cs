...
namespace Travel.Web.Services.CommentService
{
    public class CommentService : ICommentService
    {
            ...
            IMapper mapper)
        {
            ...
            _commentCollection =
                database.GetCollection<Comment>(
        ...
        {
            var comment =
                _mapper.Map<Comment>(createCommentDto);
        ...
        public async Task<List<ResultCommentDto>> GetAllAsync()
        {
            ...
            return _mapper
                .Map<List<ResultCommentDto>>(comments);
        }
        ...
        public async Task<ResultCommentDto> GetByIdAsync(string id)
        {
            ...
            return _mapper
                .Map<ResultCommentDto>(comment);
        }


        public async Task<List<ResultCommentDto>>
            GetByTourIdAsync(string tourId)
        {
            var comments =
                await _commentCollection
                    .Find(x =>
